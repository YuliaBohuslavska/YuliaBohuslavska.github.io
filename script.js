...
const modalPlanetarium = document.getElementById("modal3");

const buttonOpenCards = document.getElementById('show-modal-1');
const buttonOpenPiano = document.getElementById('show-modal-2');
const buttonOpenPlanetarium = document.getElementById('show-modal-3');

const buttonClose = document.getElementsByClassName("modal-close");
const overlay = document.getElementById('overlay-modal')

buttonOpenPlanetarium.onclick =  function () {
    modalPlanetarium.style.visibility = 'visible';
    overlay.style.visibility = 'visible';
};
buttonClose[0].onclick = function () {
    modalPlanetarium.style.visibility = 'hidden';
